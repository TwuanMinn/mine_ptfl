  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'bg-gradient-to-br from-black via-slate-900 to-black' : 'bg-gradient-to-br from-blue-50 via-cyan-50 to-white'}`}>
            ...
            <div className="hidden md:flex space-x-8 items-center flex-1 justify-end">
              {['about', 'skills', 'projects', 'experience', 'contact'].map((item) => (
                <div key={item} className="relative group pb-1">
                  ...
                  >
                    <span className={`capitalize font-semibold transition-colors duration-200 ease-out ${
                      activeSection === item 
                  ...
                  <span 
                    className={`absolute bottom-0 left-0 h-0.5 ${darkMode ? 'bg-blue-400' : 'bg-blue-600'} transition-all duration-200 ease-out ${
                      activeSection === item 
                        ? 'w-full' 
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className={`fixed bottom-8 right-8 p-3 rounded-full transition-all duration-300 transform hover:scale-110 z-40 ${
            darkMode 
